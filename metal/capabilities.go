...
// Integer dtypes use widening kernels (elementwiseIntegerWorkDType, reduce.metal).
// FusedDense and FusedAttentionQKVProjection use dedicated fused MSL entry points
// (fused_dense_*, fused_qkv_projection_*) when shapes/dtypes allow; otherwise they
// lower to primitive ops.
