...
REDUCE_KERNEL(reduce_sum_i64, int64_t,
    int64_t(0),
    acc + val,
    acc)

REDUCE_KERNEL(reduce_product_i64, int64_t,
    int64_t(1),
    acc * val,
    acc)

REDUCE_KERNEL(reduce_max_i64, int64_t,
    as_type<int64_t>(uint64_t(0x8000000000000000)),
    max(acc, val),
    acc)

REDUCE_KERNEL(reduce_min_i64, int64_t,
    as_type<int64_t>(uint64_t(0x7FFFFFFFFFFFFFFF)),
    min(acc, val),
    acc)

REDUCE_KERNEL(reduce_sum_u64, uint64_t,
    uint64_t(0),
    acc + val,
    acc)

REDUCE_KERNEL(reduce_product_u64, uint64_t,
    uint64_t(1),
    acc * val,
    acc)

REDUCE_KERNEL(reduce_max_u64, uint64_t,
    uint64_t(0),
    max(acc, val),
    acc)

REDUCE_KERNEL(reduce_min_u64, uint64_t,
